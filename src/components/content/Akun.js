        ...
        <div className="pr-sidebar">
          <ul className="pr-sidebar-nav">
            <li className="pr-sidebar-nav-item">
              <Link to={`/profile`} className="pr-sidebar-nav-link active">
                <div>
            ...
            <li className="pr-sidebar-nav-item">
              <Link to={`/rekening`} className="pr-sidebar-nav-link ">
              ...
              <div className="pr-card">
                ...
                <div className="pr-card-content ">
                  <legend>
                    ...
                    <a className="button" style={{marginRight:'20px'}}> Ubah Profile</a>

                    <a className="button">Ubah Password</a>
                    </div>
                  </legend>
                </div>
              </div>
